...
{
    public sealed partial class SuppressionPage : Page
    {
        ...
        private void SuppressionButton_Click(object sender, RoutedEventArgs e)
        {
            Frame.Navigate(typeof(SuppressionPage));
        }
    }
}
